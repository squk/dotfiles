...
let s:themes['default'] = {
      \   'maintainer'  : 'Christian Nieves <christian@osirisltd.com>',
      \   'description' : 'VIM theme for Osiris Ltd. '
      \ }
...
let s:themes['default'].light = {
      ...
      \       'cursor_bg' : ['#005f87', '254'],
      \       'cursorline' : ['#e4e4e4', '255'],
...
fun! s:set_color_variables()
  ...
  let s:vertsplit_fg = get(s:palette, 'vertsplit_fg', get(s:palette, 'color08')) + ['White']
  ...
  let s:cursor_bg = get(s:palette, 'cursor_bg', get(s:palette, 'color00')) + ['Black']
